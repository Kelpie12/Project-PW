...
<body>
        ...
        <div class="header">
            ...
            <div class="ui inverted secondary pointing menu">
                ...
                <div class="item">
                    ...
                    <a style="margin-right:15vw;"><h3 style="color:white;">UWU</h3></a>
                </div>
    ...
    <footer>
            <div class="ui bottom fixed large menu">
                <a class="item"><h3>UWU-SHOP</h3></a>
                <a class="item"><h5 class="bottom-item">About Us</h5></a>
                <a class="item"><h5 class="bottom-item">Create Account</h5></a>
                <a class="item"><h5 class="bottom-item">Home Catalog</h5></a>

                <div class="right menu">
                    <div class="ui item">
                        2019, Made by UWU Team
                    </div>
                </div>
    ...
    <script>
        var rotator1imgs = new Array("banner1.jpg", "banner2.jpg");
